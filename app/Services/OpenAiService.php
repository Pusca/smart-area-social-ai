...
class OpenAiService
{
    ...
    public function generateContent(array $context): array
    {
        ...
        $instructions = ($visualModeGptInstruction !== '' ? $visualModeGptInstruction . "\n\n" : '')
            ...
            . "REGOLA FONDAMENTALE DI SCRITTURA SOCIAL — asset_variables, asset_identity e identity_assets definiscono CHI o COSA appare nel visual: sono soggetti visivi e istruzioni per la generazione grafica, NON elementi da nominare o annunciare nel copy.\n"
            . "Non scrivere mai nella caption, nel voiceover o nel reel_blueprint frasi come 'Guarda [nome asset] in azione', 'Ecco [nome persona]', 'Scopri [nome luogo]', '[Nome] e pronto per te' o qualsiasi costruzione che citi direttamente il nome dell'asset o della variabile.\n"
            . "Scrivi invece come farebbe un brand social autentico: racconta il tema, l'esperienza vissuta, il momento, il servizio, l'emozione o il beneficio — senza fare da speaker che introduce o annuncia il soggetto visivo.\n"
            . "Se il soggetto visuale e una persona del brand (chef, staff, fondatore, atleta), la caption parla del piatto, della tecnica, del gesto, dell'expertise o del valore — non introduce la persona per nome salvo che brief_seed o prompt_notes dell'asset lo richiedano esplicitamente come stile narrativo voluto.\n"
            . "Se il soggetto visuale e un luogo del brand (ristorante, studio, negozio, sala), la caption evoca atmosfera, proposta concreta e invito naturale — non descrive il luogo come se fosse uno spot pubblicitario o un comunicato stampa.\n"
            . "Per i video, video_prompt e voiceover descrivono scene, movimenti e sensazioni in modo cinematico — non annunciano che la persona o il luogo sta per comparire in frame.\n"
            ...
            . "COERENZA NARRATIVA CRITICA: image_prompt e video_prompt devono riflettere visivamente il TEMA SPECIFICO della caption — non possono essere immagini brand generiche. Se la caption parla di un momento specifico, un processo o un concetto concreto, il visual deve MOSTRARE QUELLA COSA SPECIFICA, non una foto ambientale del brand. Es: caption su 'il processo di fermentazione artigianale' → image_prompt mostra il momento del processo, non un generico interno del locale.\n"
            . "Se item_brain.content_structure_meta.video_segments e presente, usalo come traccia narrativa per costruire reel_blueprint.shots coerenti con quella struttura.\n"
            . "Se il formato e video, genera anche video_prompt: centrato su scene specifiche al topic, movimento, ordine delle inquadrature, transizioni e fedelta dei riferimenti reali. Il video_prompt deve descrivere COSA ACCADE nella scena, non come si fa la fotografia.\n"
            ...
            . "Se il formato e reel, genera reel_blueprint con ARCO NARRATIVO PRECISO. Un reel di qualita non e una sequenza di clip generiche: e un micro-film con inizio chiaro (tensione o contrasto visivo), sviluppo (processo o gesto chiave) e fine (risoluzione o trasformazione visibile).\n"
            . "reel_blueprint deve contenere:\n"
            . "- hook (string): descrive IL MOMENTO ESATTO DI APERTURA specifico per il topic — es. NON 'apri con qualcosa di fermascroll' ma 'inquadratura stretta delle mani che aprono la confezione, la superficie del prodotto ancora intatta, luce laterale calda'\n"
            . "- anchor_frame (string): IL FRAME FONDANTE che stabilisce l'identita visiva del reel — soggetto, ambiente, luce dominante, tutto specifico\n"
            . "- continuity_lock (string): UN ELEMENTO VISIVO CONCRETO che lega tutti gli shot — es. 'stessa persona in stesso abbigliamento', 'il bancone del laboratorio come sfondo ricorrente', 'palette calda arancio/legno in ogni inquadratura'\n"
            . "- visual_payoff (string): IL MOMENTO FINALE DI RISOLUZIONE — cosa si vede esattamente nell'ultimo shot che chiude la storia\n"
            . "- shots (array di 3 o 4 oggetti)\n"
            . "Ogni shot deve avere: order (numero), purpose (stringa SPECIFICA — descrive cosa accade in quella scena, non solo il tipo di shot), subject (il soggetto concreto), camera (angolazione e distanza), motion (tipo di movimento).\n"
            . "I shot devono seguire una progressione narrativa: Shot 1 = PRIMA (il problema, il contrasto, il momento di tensione o lo stato iniziale); Shot 2-3 = DURANTE (il processo, il gesto tecnico, il momento di svolta); Shot finale = DOPO (il risultato, la trasformazione, il payoff visibile).\n"
            . "Il voiceover deve accompagnare questo arco: frase 1 apre la tensione sul topic reale del contenuto, frase 2 sviluppa con il punto chiave, frase 3 chiude con il payoff concreto.\n"
            . "Per i reel evita location multiple senza filo logico: meglio 1-2 ambienti coerenti con progressione fluida.\n"
