...
class GenerationRun extends Model
{
    ...
    protected $casts = [
        ...
        'identity_validation' => 'array',
        'publish_gate' => 'array',
        'overlay_meta' => 'array',
        'storyboard_meta' => 'array',
        'token_usage' => 'array',
    ...
    public function toTimelineArray(): array
    {
        return [
            'run' => [
                ...
                'identity_validation' => $this->identity_validation,
                'publish_gate' => $this->publish_gate,
                'overlay_meta' => $this->overlay_meta,
                'storyboard_meta' => $this->storyboard_meta,
