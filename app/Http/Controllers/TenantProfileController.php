...
class TenantProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'visual_mode' => ['nullable', 'string', \Illuminate\Validation\Rule::in(array_keys(\App\Support\VisualModePresets::all()))],
            ...
            $profile = TenantProfile::query()->updateOrCreate(
                ...
                [
                    ...
                    'overlay_preferences' => array_merge($existingOverlayPreferences, [
                        ...
                        'visual_mode' => $data['visual_mode'] ?? $existingOverlayPreferences['visual_mode'] ?? \App\Support\VisualModePresets::DEFAULT_MODE,
                    ]),
    ...
    public function storeGuidedPersonaVariable(Request $request)
    {
        $data = $request->validate([
            ...
            'prompt_notes' => 'nullable|string|max:1200',
            'usage_notes' => 'nullable|string|max:1200',
            'shot_front' => 'required|file|mimes:png,jpg,jpeg,webp|max:20480',
            'shot_three_quarter_left' => 'required|file|mimes:png,jpg,jpeg,webp|max:20480',
            'shot_three_quarter_right' => 'required|file|mimes:png,jpg,jpeg,webp|max:20480',
            'shot_profile' => 'required|file|mimes:png,jpg,jpeg,webp|max:20480',
            'shot_half_body' => 'nullable|file|mimes:png,jpg,jpeg,webp|max:20480',
            'reference_video' => 'nullable|file|mimetypes:video/mp4,video/quicktime,video/webm|max:307200',
            'voice_sample' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:307200',
        ]);
    ...
    public function storeVariableAssets(Request $request, AssetVariable $assetVariable)
    {
        ...
        $data = $request->validate([
            ...
            'variable_images.*' => 'file|mimes:png,jpg,jpeg,webp|max:20480',
            'variable_videos' => 'nullable|array|max:6',
            'variable_videos.*' => 'file|mimetypes:video/mp4,video/quicktime,video/webm|max:307200',
            'variable_audios' => 'nullable|array|max:6',
            'variable_audios.*' => 'file|mimes:mp3,wav,m4a,ogg,webm|max:307200',
